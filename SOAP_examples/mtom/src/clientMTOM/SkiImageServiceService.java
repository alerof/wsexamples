...
public class SkiImageServiceService extends Service {
	...
	static {
		...
		try {
			...
			logger.warning(
					"Failed to create URL for the wsdl Location: 'http://localhost:9876/ski?wsdl', retrying as a local file");
	...
	public SkiImageServiceService() {
		super(SKIIMAGESERVICESERVICE_WSDL_LOCATION, new QName("http://images/", "SkiImageServiceService"));
	}
