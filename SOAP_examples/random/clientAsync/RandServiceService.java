 ...
 * 
 */
@WebServiceClient(name = "RandServiceService", targetNamespace = "http://rand/", wsdlLocation = "http://localhost:9090/randomTcat/rand?wsdl")
public class RandServiceService extends Service {
	...
	static {
		...
		try {
			...
			url = new URL(baseUrl, "http://localhost:9090/randomTcat/rand?wsdl");
		} catch (MalformedURLException e) {
			logger.warning(
					"Failed to create URL for the wsdl Location: 'http://localhost:8888/rs?wsdl', retrying as a local file");
